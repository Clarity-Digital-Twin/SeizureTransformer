...
# file: $NEDC_NFC/class/python/nedc_eeg_eval_tools/nedc_eeg_eval_epoch.py
#
# revision history:
#
...
def run(events_ref, events_hyp, mapping, nedc_epoch, odir, rfile, fp):
    """
    function: run
    ...
    status = nepoch.score(events_ref, events_hyp, mapping, rfile)
    if status == False:
