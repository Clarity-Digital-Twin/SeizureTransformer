...
When tuned toward deployment goals, the model cannot meet standard clinical thresholds with NEDC scoring: targeting 10 FA/24h achieves 33.90% sensitivity, below the ≥50% requirement. Acceptable false‑alarm rates occur only under SzCORE’s permissive tolerances.
